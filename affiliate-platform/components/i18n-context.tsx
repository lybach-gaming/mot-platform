...
const translations: Translations = {
  ...
  referralLinkGenerator: { en: "Referral Link Generator", fr: "Générateur de lien de parrainage" },
  activeCampaigns: { en: "Active Campaigns", fr: "Campagnes actives" },
  customLinkGenerator: { en: "Custom Link Generator", fr: "Générateur de lien personnalisé" },
  earningsReports: { en: "Earnings Reports", fr: "Rapports de revenus" },
  commissionEarnings: { en: "Commission Earnings", fr: "Revenus de commission" },
  affiliateLeaderboard: { en: "Affiliate Leaderboard", fr: "Classement des affiliés" },
